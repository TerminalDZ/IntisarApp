      ...
      success: function (data) {
        ...
        if (data.status == "success") {
          ...
          data.data.forEach(function (family) {
            var familyIdentifier = family.father_name + "-" + family.last_name;

            if (!addedFamilies.has(familyIdentifier)) {
              addedFamilies.add(familyIdentifier);
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.status == "success") {
          ...
          if (
            data.data["family_status"] == "وفاة كلا الوالدين" ||
            data.data["family_status"] == "مطلقان" ||
            data.data["family_status"] == "وفاة الأب"
          ) {
            $("#caregiver_div").show();
