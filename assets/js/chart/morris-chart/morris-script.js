...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: ["#126139", "#fe80b2" ,"#80cf00"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: ["rgba(126, 55, 216, 1)", "rgba(253, 81, 125, 1)" ,"rgba(128, 207, 0, 1)" ,"rgba(254, 128, 178, 1)" ,"rgba(0, 123, 255, 1)", "rgba(30, 166, 236, 1)" ,"rgba(21, 141, 247, 1)"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: ["#126139", "#80cf00" ,"#fe80b2" ,"#ff5a75" ,"#ff9f40", "#1ea6ec" ,"#126139"],
                stacked: !0
            });
        });
    }
