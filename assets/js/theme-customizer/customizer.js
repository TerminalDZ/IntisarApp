...
$('<div class=customizer-links><div class="flex-column nac-pills nav"id=c-pills-tab role=tablist aria-orientation=vertical><a aria-controls=c-pills-profile aria-selected=false class=nav-link data-toggle=pill href=#c-pills-profile id=c-pills-profile-tab role=tab><div class="color-settings settings"><img alt=""src=../assets/images/color-picker.png></div></a></div></div><div class=customizer-contain><div class=tab-content id=c-pills-tabContent><div class="custom-scrollbar customizer-body"><i class="icofont-close icon-close"></i><div class="fade tab-pane"id=c-pills-profile role=tabpanel aria-labelledby=c-pills-profile-tab><h6>وضع المضيء</h6><ul class="layout-grid customizer-color"><li class=color-layout data-attr=color-1 data-primary=#126139data-secondary=#fe80b2><div></div><li class=color-layout data-attr=color-2 data-primary=#0288d1 data-secondary=#26c6da><div></div><li class=color-layout data-attr=color-3 data-primary=#8e24aa data-secondary=#ff6e40><div></div><li class=color-layout data-attr=color-4 data-primary=#4c2fbf data-secondary=#2e9de4><div></div><li class=color-layout data-attr=color-5 data-primary=#7c4dff data-secondary=#7b1fa2><div></div><li class=color-layout data-attr=color-6 data-primary=#3949ab data-secondary=#4fc3f7><div></div></ul><h6>وضع الظلام</h6><ul class="layout-grid customizer-color dark"><li class=color-layout data-attr=color-1 data-primary=#126139data-secondary=#fe80b2><div></div><li class=color-layout data-attr=color-2 data-primary=#0288d1 data-secondary=#26c6da><div></div><li class=color-layout data-attr=color-3 data-primary=#8e24aa data-secondary=#ff6e40><div></div><li class=color-layout data-attr=color-4 data-primary=#4c2fbf data-secondary=#2e9de4><div></div><li class=color-layout data-attr=color-5 data-primary=#7c4dff data-secondary=#7b1fa2><div></div><li class=color-layout data-attr=color-6 data-primary=#3949ab data-secondary=#4fc3f7><div></div></ul><h6>وضع المختلط</h6><ul class="layout-grid customizer-mix"><li class="color-layout active"data-attr=light-only><div class="bg-light header"><ul><li><li><li></ul></div><div class=body><ul><li class="bg-light sidebar"><li class="body bg-light"></ul></div><li class=color-layout data-attr=sidebar-dark><div class="bg-light header"><ul><li><li><li></ul></div><div class=body><ul><li class="bg-dark sidebar"><li class="body bg-light"></ul></div><li class=color-layout data-attr=dark-only><div class="bg-dark header"><ul><li><li><li></ul></div><div class=body><ul><li class="bg-dark sidebar"><li class="body bg-dark"></ul></div></ul></div></div></div></div>').appendTo($('body'));
(function() {
})();
//live customizer js
